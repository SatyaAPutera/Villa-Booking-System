...
@section('content')
    <div>
        <section class="page-header min-vh-80"
            style="background-image: url('/assets/img/jamu1 (12).jpg');"
            loading="lazy">
            <span class="mask bg-gradient-dark opacity-5"></span>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-7 d-flex justify-content-center flex-column">
                        <h1 class="text-white mb-4">Welcome to Jamu Real Estate</h1>
                        <p class="text-white opacity-8 lead pe-5 me-5">Your Ultimate Destination for Hassle-Free Villa
                            Bookings. Discover Comfort, Convenience, and Quality Stays at Jamu Real Estate</p>
                        <div class="buttons">
